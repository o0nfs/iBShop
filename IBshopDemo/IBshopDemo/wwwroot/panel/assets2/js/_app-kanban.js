...
(async function () {
    ...
    //const url = 'https://localhost:5001/companies/GetCompanyCardsData';
    ...
    //        boards = JSON.parse(xhr.responseText) /* await kanbanResponse.json();*/



    //    } else if (xhr.readyState === 4) {
    //        // Handle error or non-200 status codes
    ...
    //// Get kanban data
    //await fetch(assetsPath + 'json/kanban.json').then(function () {
    //});
    ...
    function renderBoardDropdown() {
        return (
            ...
            "<a class='dropdown-item delete-board' href='javascript:void(0)'> <i class='ti ti-trash ti-xs' me-1></i> <span class='align-middle'>Delete Company Type</span></a>" +
            "<a class='dropdown-item' href='javascript:void(0)'><i class='ti ti-edit ti-xs' me-1></i> <span class='align-middle'>Edit Company Type <span></a>" +
            "<a class='dropdown-item' href='javascript:void(0)'><i class='ti ti-archive ti-xs' me-1></i> <span class='align-middle'>Show Id</span></a>" +
            '</div>' +
            '</div>'
        );
    }
    ...
    function renderDropdown() {
        return (
            ...
            "<a class='dropdown-item' href='javascript:void(0)'>Edit Company</a>" +
            "<a class='dropdown-item' href='javascript:void(0)'>Delete Company</a>" +
            "<a class='dropdown-item' href='javascript:void(0)'>Add Branch</a>" +
            "<a class='dropdown-item' href='javascript:void(0)'>Add Branch Unit</a>" +
            "<a class='dropdown-item delete-task' href='javascript:void(0)'>Show ID</a>" +
            '</div>' +
            '</div>'
        );
    }
    ...
    function renderFooter(attachments, comments, assigned, members) {
        return (
            ...
            "<div class='d-flex'> <span class='d-flex align-items-center me-2'><i class='ti ti-building-store ti-xs me-1'></i>" +
            "<span class='attachments'>" +
            attachments +
            '</span>' +
            "</span> <span class='d-flex align-items-center ms-1'><i class='ti ti-briefcase ti-xs me-1'></i>" +
            '<span> ' +
            comments +
            ' </span>' +
            '</span></div>' +
    ...
    $.ajax({
        url: '/companies/GetCompanyCardsData',
        type: 'get',
        ...
        const kanban = new jKanban({
            ...
            itemAddOptions: {
                ...
                content: '+ Add New Company', // text or html content of the board button
